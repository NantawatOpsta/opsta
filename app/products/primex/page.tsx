...
import { Cloud, Database, Settings, Shield, Users, BarChart3, Check, Workflow, Lock, Globe, Zap } from "lucide-react"
...
export default function PrimeXPage() {
  ...
  const dashboardImages = [
    {
      src: "/primex-dashboard-main.png",
      alt: "PrimeX Main Dashboard",
      title: "Main Dashboard",
    },
    {
      src: "/primex-user-management.png",
      alt: "User Management Dashboard",
      title: "User Management",
    },
    {
      src: "/primex-vm-instances.png",
      alt: "VM Instances Dashboard",
      title: "VM Instances",
    },
    {
      src: "/primex-billing.png",
      alt: "Billing & Cost Management",
      title: "Billing & Cost Management",
    },
    {
      src: "/primex-monitoring.png",
      alt: "Monitoring Dashboard",
      title: "Monitoring Dashboard",
    },
    {
      src: "/primex-storage.png",
      alt: "Storage Management",
      title: "Storage Management",
    },
    {
      src: "/primex-infrastructure.png",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                />
                <h1 className="text-5xl md:text-7xl font-bold text-foreground text-balance">PrimeX Platform</h1>
              </div>
              <p className="text-xl text-muted-foreground mb-8 text-pretty">
                Unify your hybrid infrastructure with comprehensive multi-platform management, automated provisioning,
                and intelligent orchestration across cloud and on-premises environments.
              </p>
            ...
            <div className="lg:pl-8">
              <CardSwap images={dashboardImages} interval={4000} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Everything you need to manage and orchestrate your hybrid infrastructure
            </p>
          </div>
      ...
      <section className="py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Enterprise-grade features for complex infrastructure requirements
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Workflow orchestration with Ansible integration and automated job queues
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  SSO integration, audit trails, and comprehensive security controls
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  REST APIs, webhooks, and ITSM integrations for seamless workflows
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Plugin system, developer docs, and Backstage-like create workflows
                </p>
              </CardContent>
            </Card>
          </div>
